...
across data partitions; and (iii) training exclusively on FantasyID without any
external pre-training, DocVerify achieves results competitive with the top-3
entries of the DeepID 2025 Challenge, surpassing the winner on Track~2
localization ($0.807$ vs.\ $0.784$) and all FantasyID-only systems on Track~1
detection.
...
anomalies~\citep{noiseprint2020}) for domain-invariant representations, and
...
and Artificial Intelligence at the University of Oviedo, Spain. The author
thanks Rafael Gonz\'{a}lez Quesada for his participation in the project, and
