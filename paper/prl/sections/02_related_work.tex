...
with over 876\,000 pre-training images.
...
FantasyID confirm that general-purpose baselines (TruFor, MMFusion, FatFormer,
UniFD) all achieve false-negative rates above 50\% at a 10\% false-positive
...
EdgeDoc, a lightweight CNN-Transformer encoder (EdgeNeXt) fed with the green
...
In multi-task learning~\citep{caruana1997multitask, ruder2017overview}, the
...
NSGA-II~\citep{nsga2_2002}---critical when each evaluation requires training a
deep network. To our knowledge, this is the first work to apply Pareto-based
