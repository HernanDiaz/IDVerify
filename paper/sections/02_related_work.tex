...
The SIDTD dataset~\cite{TODO_sidtd} provides a first large-scale benchmark for
...
DINOv2~\cite{TODO_vit} representations with multi-head self-attention fusion for
