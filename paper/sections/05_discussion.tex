...
$0.728 \pm 0.053$ ($p = 1.5 \times 10^{-8}$). This asymmetry shows that the
segmentation task benefits strongly from the joint objective (the encoder
receives gradient signal from both tasks), while the segmentation logit alone
is insufficient for document-level detection. The binary detection of an
