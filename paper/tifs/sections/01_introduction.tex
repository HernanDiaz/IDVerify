...
identity theft, illegal immigration, and financial crime~\cite{europol2022deepfakes}.
...
regulations~\cite{euaiact2024}: a binary ``tampered'' label cannot satisfy the
