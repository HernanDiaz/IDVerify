...
$d = 1.01$) while maintaining competitive PR-AUC\rev{, and the distance-to-ideal
selection criterion outperforms scalar PR-AUC- or Dice-maximizing selection on
the same Pareto front}; (ii) under a rigorous 10-fold
...
comparable blind-test performance (Sec.~\ref{subsec:generalization}), indicating
the approach is not tied to a specific architecture. By contrast, our zero-shot
evaluation on SIDTD exposed a substantial cross-domain gap
